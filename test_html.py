...
# Basic options
# parser.add_argument('--content', type=str,default = 'input/content/fanbohao.jpg',
...
parser.add_argument('--decoder_path', type=str, default='experiments2/decoder_iter_32000.pth')
parser.add_argument('--transform_path', type=str, default='experiments2/ma_module_iter_32000.pth')
...
with open('风格转换UI界面.html', 'r', encoding='utf-8') as f:
    Soup = BeautifulSoup(f.read(), 'html.parser')
    content_paths = Soup.select('image_id')['src']
print(content_paths)
...
with open('风格转换UI界面.html', 'r', encoding='utf-8') as f:
    Soup = BeautifulSoup(f.read(), 'html.parser')
    style_paths = Soup.select('style_id')['src']
print(style_paths)
